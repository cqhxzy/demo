...
public class ImgTools {
    ...
    public static void main(String[] args) throws IOException {
        File img = new File("C:\\Users\\Administrator\\Pictures\\1.jpg");
        FileOutputStream fos = new FileOutputStream("C:\\Users\\Administrator\\Pictures\\2.jpg");
        ImgTools.thumbnail(img, 450, 150, fos);
